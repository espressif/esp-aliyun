...
#define SUB_1_PRODUCT_KEY              "b1KfGfUCsbU"
#define SUB_1_DEVICE_NAME              "subdev_001"
#define SUB_1_DEVICE_SECRET            "ygC08LqfRQRx0tG9LXyIwv9qM0z8xUwl"

#define SUB_2_PRODUCT_KEY              "b1KfGfUCsbU"
#define SUB_2_DEVICE_NAME              "subdev_002"
#define SUB_2_DEVICE_SECRET            "HbDMiaUcJbRjDFsmBuUxdfPRywjMoo7m"
...
void gateway_subdev_main(void *pvParameter)
{
    ESP_LOGI(TAG, "gateway_subdev_main task started...");
    while (1) { // reconnect to tls
        ...
        ESP_LOGI(TAG, "gateway_subdev_main example end, free heap size:%d", system_get_free_heap_size());
    }
    return;
}
...
void app_main()
{
    ...
    initialise_wifi();
    xTaskCreate(&gateway_subdev_main, "gateway_subdev_main", 32*1024, NULL, 5, NULL);
}
